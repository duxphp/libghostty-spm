...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/dux-web/libghostty-spm/releases/download/storage.1.0.1788785126/GhosttyKit.xcframework.zip",
            checksum: "eea1286ca040024d1f407ee4e9a90ff287f0bcb985efed665f4d0f734c8ed692"
        ),
        .testTarget(
            name: "GhosttyKitTest",
